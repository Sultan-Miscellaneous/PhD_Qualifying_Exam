{ signal: [
  { name: "clk", wave: 'P................' },
  { name: "Conv_3_3 [state]", wave: '==..=...|=..|=..|', data: ["Start", "Load Weights Fi_Cj  10 cycles", "Pipeline Delay (Pad) 450 cycles             ", "Valid_Output (222x224) cycles", "Pad 224 cycles", "Compute"]},
  ...
  { name: 'buffer_r_0 [psums] -> AGG[Input_1]', wave: 'x...=.=.|=..|=..|', data: [ "Start @224 cycles", "psums (Fi_C(j-1))", "psums (Fi_C(j-1))",  "psums (Fi_C(j-1))", "[0,2]", "[1,0]", "[1,1]", "[1,2]", "[1,3]", "[2,4]", "[2,5]", "[2,6]", "[2,223]", "Delay", "[3,0]", "[3,1]", "[3,2]", "[3,3]", "[3,4]", "[223, 222]", "[223, 223]"] },
