{ signal: [
  ...
  { name: "Conv_3_3_3 [state]", wave: 'xxxxx..==..=.....=...|=........', data: ["Start", "Weights F0_C4", "Sync", "Pipeline Delay (451) ", "ofmap(222x224)    "]},
  ...
  { name: 'buffer_r_i [ifmap_ci] -> Conv_3_3_i & Conv_3_3_(i+4)', wave: 'xxxxxxxxxxxxxxxxxx345.|345|xxxx', data: ["[i,0,1]", "[i,0,1]", "[i,0,2]", "[i,2,0]", "[i,2,1]", "[i,2,2]", "0", "[2,4]", "[2,5]", "[2,6]", "[2,223]", "Delay", "[3,0]", "[3,1]", "[3,2]", "[3,3]", "[3,4]", "[223, 222]", "[223, 223]"] },
